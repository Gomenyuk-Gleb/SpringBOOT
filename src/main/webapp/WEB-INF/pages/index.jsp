    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="download" class="btn btn-default navbar-btn">Download</button></li>
                            <li><button type="button"  id="save" class="btn btn-default navbar-btn" >Save</button></li>
        ...
        <script>
            ...
            $('#download').click(function(){
                window.location.href='/download/toxml';
            });
